...
from app.schema.user_schema import UserVerify,UserCreate,UserReturn,UserRegister
...
@router.post("/create")
async def create_users(data:UserRegister ,background_Task:BackgroundTasks,db=Depends(get_db)):
